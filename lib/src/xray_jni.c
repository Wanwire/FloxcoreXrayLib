...
JNIEXPORT jlong JNICALL Java_com_wanwire_libxraygo_XrayGo_libxrayMain(
    JNIEnv *env, jobject obj, jint argc, jobjectArray argv, jint envc,
    jobjectArray envv) {
...
JNIEXPORT void JNICALL Java_com_wanwire_libxraygo_XrayGo_libxrayStop(
    JNIEnv *env, jobject obj, jint argc, jobjectArray argv, jint envc,
    jobjectArray envv) {
  libxray_stop();
}
